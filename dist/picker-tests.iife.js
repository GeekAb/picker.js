...
(function () {
  ...
  var safeDispose = function safeDispose() {
  ...
  var assertData = function assertData() {
  ...
  var findPopper = function findPopper() {
    return $$2(Selector.POPPER);
  };

  var assertNotFound = function assertNotFound(selector) {
    expect($$2(selector).length, selector).to.equal(0);
  };

  var assertVisible = function assertVisible(selector) {
    var $element = $$2(selector);
    expect($element, selector).to.be.visible;
    return $element;
  };

  var assertHidden = function assertHidden(selector) {
    var $element = $$2(selector);
    expect($element, selector).to.be.hidden;
    return $element;
  };

  var assertText = function assertText(selector, text) {
    var $element = $$2(selector);
    expect($element, selector).to.contain(text);
    return $element;
  };

  var assertDatesEqual = function assertDatesEqual(actual, expected) {
    var granularity = arguments.length <= 2 || arguments[2] === undefined ? 'millisecond' : arguments[2];

    var msg = (actual ? actual.format() : null) + ' should equal ' + (expected ? expected.format() : null);
  ...
  $$2.expr[':'].textEquals = function (el, i, m) {
    var searchText = m[3];
    var match = $$2(el).text().trim().match('^' + searchText + '$');
  ...
  var findToday = function findToday() {
    var selector = Selector.DAYS + ' td' + Selector.TODAY;
    return assertFound(selector);
  };

  var findActiveDay = function findActiveDay() {
    var selector = Selector.DAYS + ' ' + Selector.DAY + Selector.ACTIVE;
    return assertFound(selector);
  };

  var findFocusedDay = function findFocusedDay() {
    var selector = Selector.DAYS + ' ' + Selector.DAY + Selector.FOCUSED;
    return assertFound(selector);
  };

  var findMonth = function findMonth(month) {
    var selector = Selector.MONTHS + ' tbody td span:textEquals(' + month + ')';
    return assertFound(selector);
  };

  var findYear = function findYear(year) {
    var selector = Selector.YEARS + ' tbody td span:textEquals(' + year + ')';
    return assertFound(selector);
  };

  var findDecade = function findDecade(decade) {
    var selector = Selector.DECADES + ' tbody td span:textEquals(' + decade + ')';
    return assertFound(selector);
  };

  var findCentury = function findCentury(century) {
    var selector = Selector.CENTURIES + ' tbody td span:textEquals(' + century + ')';
    return assertFound(selector);
  };

  var findPrev = function findPrev() {
    var selector = Selector.DAYS + ' th' + Selector.PREV;
    return assertFound(selector);
  };
  var findNext = function findNext() {
    var selector = Selector.DAYS + ' th' + Selector.NEXT;
    return assertFound(selector);
  };

  var findMonthsSwitch = function findMonthsSwitch() {
    return assertFound(Selector.DAYS + ' thead th' + Selector.SWITCH);
  };

  var findYearsSwitch = function findYearsSwitch() {
    return assertFound(Selector.YEARS + ' thead th' + Selector.SWITCH);
  };

  var findDecadesSwitch = function findDecadesSwitch() {
  ...
  var fireKey = function fireKey(keycode) {
    var shiftKey = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
    var ctrlKey = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
  ...
  var moment=__commonjs(function(module,exports,global){ //! moment.js
  //! version : 2.13.0
  ...
  describe('Datepicker', function () {
    ...
    describe('autoclose', function () {
      it('should autoclose after day click', function () {
        ...
        dp.show();
        var $day = findDayOfMonth('21');
        $day.click();

        assertNotFound(Selector.POPPER);
        assertDatesEqual(dp.getDate(), moment$1('03/21/2012'));
      });
    });
  });
  ...
  describe('Datepicker', function () {
    ...
    describe('format', function () {
      it('should set default from momentjs locale', function () {
        $input.datepicker();
        var dp = assertData();
        expect(dp.config.format, 'config.format').to.equal(moment$1().localeData().longDateFormat('L'));
      });

      it('can be set in constructor', function () {
  ...
  describe('Datepicker', function () {
    ...
    describe('today', function () {
      describe('button', function () {
        ...
        it('should show when enabled', function () {
          $input.datepicker({
            button: { today: true }
          });
          assertData().show();
        ...
        it('should move to today\'s date', function () {
          $input.val('2012-03-05').datepicker({
            format: YYYY_MM_DD,
            button: { today: true }
          });
          ...
          dp.show();
          assertVisible(Selector.DAYS);
          var $button = assertVisible(Selector.DAYS + ' tfoot ' + Selector.TODAY);
      ...
      describe('classes', function () {
        it('no date specified should have \'today focused\'', function () {
          $input.datepicker();
          ...
          var $notToday = findDayOfMonth(new String(moment$1().date() == 10 ? 11 : 10));
        ...
        it('today clicked should have \'today focused active\'', function () {
          $input.datepicker();
  ...
  describe('Datepicker', function () {
    ...
    describe('view', function () {
      describe('start', function () {
        ...
        it('should show decades', function () {
          $input.datepicker({
            view: { start: 'decades' }
          });
        ...
        it('should show centuries', function () {
          $input.datepicker({
  ...
  describe('Datepicker', function () {
    ...
    describe('clear', function () {
      describe('button', function () {
        ...
        it('should hide with autoclose true', function () {
          $input.val('2012-03-05').datepicker({
            format: YYYY_MM_DD,
            button: { clear: true },
            autoclose: true
    ...
    describe('callbacks', function () {
      describe('beforeShowDay', function () {
        it('should use', function () {
          var beforeShowDay = function beforeShowDay(mom) {
            switch (mom.get('date')) {
              case 25:
                return {
      ...
      describe('beforeShowMonth', function () {
        ...
        it('should use', function () {
          ...
          var beforeShowMonth = function beforeShowMonth(mom) {
      ...
      describe('beforeShowYear', function () {
        ...
        it('should use', function () {
          ...
          var beforeShowYear = function beforeShowYear(mom) {
            switch (mom.year()) {
              case 2013:
                return {
                  tooltip: 'Example tooltip',
      ...
      describe('beforeShowDecade', function () {
        it('should use', function () {
          var beforeShowDecade = function beforeShowDecade(mom) {
            switch (mom.year()) {
              case 2030:
                return {
                  tooltip: 'Example tooltip',
      ...
      describe('beforeShowCentury', function () {
        it('should use', function () {
          var beforeShowCentury = function beforeShowCentury(mom) {
            switch (mom.year()) {
              case 2300:
                return {
                  tooltip: 'Example tooltip',
  ...
  describe('Datepicker', function () {
    ...
    describe('daysOfWeek', function () {
      ...
      describe('disabled', function () {
        it('should be marked with a class', function () {
          $input.val('10/26/2012').datepicker({
  ...
  describe('Datepicker', function () {
    ...
    describe('date', function () {
      ...
      describe('toggle', function () {
        describe('disabled', function () {
          it('clicking twice on date should leave it selected', function () {
            var expectedValue = '03/05/2012';
            var expected = moment$1(expectedValue, MM_DD_YYYY);
        ...
        describe('enabled', function () {
          it('clicking twice on date should unselect it', function () {
            var expectedValue = '03/05/2012';
            var expected = moment$1(expectedValue, MM_DD_YYYY);
      ...
      describe('count', function () {
        var expectedValue = '03/05/2012';
        var expected = moment$1(expectedValue, MM_DD_YYYY);
        var expectedValue14 = '03/14/2012';
        var expected14 = moment$1(expectedValue14, MM_DD_YYYY);
        var expectedValue21 = '03/21/2012';
        var expected21 = moment$1(expectedValue21, MM_DD_YYYY);

        it('clicking twice on date should unselect it', function () {

          var assertInitial = function assertInitial() {
        ...
        it('should limit the count using FIFO', function () {
        ...
        describe('separator', function () {
          it('should use given separator', function () {

            var SEPARATOR = '-foozled-';
      ...
      describe('start', function () {
        it('should accept moment', function () {

          var expected = moment$1('10/26/2012');
          $input.val('10/26/2012').datepicker({
            date: { start: expected }
          });
      ...
      describe('default', function () {
        it('should accept moment', function () {
          ...
          assertDatesEqual(moment$1(findDayOfMonth('26').data(Data.MOMENT)), expected);
        });
      });
    });
  });
  ...
  describe('Datepicker', function () {
    ...
    describe('showOnFocus', function () {
      it('default should show', function () {
        $input.datepicker({});
        var dp = assertData();
      ...
      it('false should remain hidden', function () {
  ...
  describe('Datepicker', function () {
    ...
    describe('enableOnReadonly', function () {
      it('default true should show popper', function () {
        $input.datepicker();
        var dp = assertData();
      ...
      it('false should not show popper', function () {
  ...
  describe('Datepicker', function () {
    ...
    describe('#update', function () {
      ...
      it('should accept null', function () {
        ...
        expect($$2(Selector.DAYS + ' td' + Selector.ACTIVE).length, 'No date should be active').to.equal(0);
      });
    });
  });
  ...
  describe('Datepicker', function () {
    ...
    describe('mouse', function () {
      describe('visibility', function () {
        ...
        it('should not hide on mousedown inside popper', function () {
          assertNotFound(Selector.POPPER);
          $input.focus();
        ...
        it('should hide on body mousedown', function () {
          assertNotFound(Selector.POPPER);
          $input.focus();
          assertVisible(Selector.POPPER);
          expect(dp.isShowing()).to.equal(true);
      ...
      describe('arrows', function () {
        ...
        var expected = moment$1('03/05/2012');
        var dp = void 0;

        it('day view', function () {
          beforeEach(function () {
            prepare();
            $input.datepicker({
              date: { default: expected }
            ...
            dp = assertData();
            dp.show();
            var $focused = findFocusedDay();
            assertDatesEqual(moment$1($focused.data(Data.MOMENT)), expected);
          });

          it('clicking prev should go to previous month', function () {
            findPrev().click();

            var $day = findDayOfMonth('21');
            assertDatesEqual(moment$1($day.data(Data.MOMENT)), moment$1('02/21/2012'));
          });

          it('clicking next should go to next month', function () {
            findNext().click();

            var $day = findDayOfMonth('21');
            assertDatesEqual(moment$1($day.data(Data.MOMENT)), moment$1('04/21/2012'));
          });
        });

        it('year view', function () {
          ...
          it('clicking prev should go to previous year', function () {
            findPrev().click();

            var $month = findMonth('Mar');
            assertDatesEqual(moment$1($month.data(Data.MOMENT)), moment$1('03/01/2011'));
          });

          it('clicking next should go to next year', function () {
            findNext().click();

            var $month = findMonth('Mar');
            assertDatesEqual(moment$1($month.data(Data.MOMENT)), moment$1('03/01/2013'));
          });
        });
      });
      ...
      describe('switch', function () {
        ...
        it('should navigate to months, years, decades, centuries, and back', function () {
          assertVisible(Selector.DAYS);
          ...
          assertDatesEqual(dp.getDate(), moment$1('01/31/2811'));
        });
      });
    });
  });
  ...
  describe('Datepicker', function () {
    ...
    describe('keyboard', function () {
      describe('tab', function () {
        ...
        it('tab should select today and hide', function () {
          fireKey(Keycodes.TAB);
          assertDatesEqual(dp.getDate(), moment$1(), 'date');
        });

        it('left then tab should select yesterday and hide', function () {
          fireKey(Keycodes.LEFT);
          fireKey(Keycodes.TAB);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'days'), 'date');
        });

        it('right then tab should select tomorrow and hide', function () {
          fireKey(Keycodes.RIGHT);
          fireKey(Keycodes.TAB);
          assertDatesEqual(dp.getDate(), moment$1().add(1, 'days'), 'date');
        });

        it('up then tab should select -7 days and hide', function () {
          fireKey(Keycodes.UP);
          fireKey(Keycodes.TAB);
          assertDatesEqual(dp.getDate(), moment$1().subtract(7, 'days'), 'date');
        });

        it('down then tab should select +7 days and hide', function () {
          fireKey(Keycodes.DOWN);
          fireKey(Keycodes.TAB);
          assertDatesEqual(dp.getDate(), moment$1().add(7, 'days'), 'date');
        });
      });

      describe('nav + enter', function () {
        var dp = void 0;
        beforeEach(function () {
          prepare();
          $input.datepicker();
        ...
        it('enter should select today', function () {
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1(), 'date');
        });

        it('left then enter should select yesterday', function () {
          fireKey(Keycodes.LEFT);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'days'), 'date');
        });

        it('left + shift then enter should select -1 month', function () {
          fireKey(Keycodes.LEFT, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'months'), 'date');
        });

        it('ctrl + left + shift then enter should select -1 year', function () {
          fireKey(Keycodes.LEFT, false, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'years'), 'date');
        });

        it('right then enter should select tomorrow', function () {
          fireKey(Keycodes.RIGHT);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().add(1, 'days'), 'date');
        });

        it('right + shift then enter should select +1 month', function () {
          fireKey(Keycodes.RIGHT, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().add(1, 'months'), 'date');
        });

        it('ctrl + right + shift then enter should select +1 year', function () {
          fireKey(Keycodes.RIGHT, false, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().add(1, 'years'), 'date');
        });

        it('up then enter should select -7 days', function () {
          fireKey(Keycodes.UP);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(7, 'days'), 'date');
        });

        it('up + shift then enter should select -1 month', function () {
          fireKey(Keycodes.UP, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'months'), 'date');
        });

        it('ctrl + up + shift then enter should select -1 year', function () {
          fireKey(Keycodes.UP, false, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().subtract(1, 'years'), 'date');
        });

        it('down then enter should select +7 days', function () {
          fireKey(Keycodes.DOWN);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().add(7, 'days'), 'date');
        });

        it('down + shift then enter should select +1 month', function () {
          fireKey(Keycodes.DOWN, true);
          fireKey(Keycodes.ENTER);
          assertDatesEqual(dp.getDate(), moment$1().add(1, 'months'), 'date');
        });

        it('ctrl + down + shift then enter should select +1 year', function () {
      ...
      describe('disabled', function () {
        ...
        describe('daysOfWeek', function () {
          it('left should skip disabled days', function () {
            ...
            fireKey(Keycodes.LEFT);
            fireKey(Keycodes.ENTER);
            assertDatesEqual(dp.getDate(), moment$1('03/01/2013'));
          });

          it('right should skip disabled days', function () {
            ...
            fireKey(Keycodes.RIGHT);
            fireKey(Keycodes.ENTER);
            assertDatesEqual(dp.getDate(), moment$1('03/18/2013'));
          });
        });
      ...
      describe('autoclose', function () {
        ...
        it('enter should select today and hide', function () {
      ...
      describe('escape', function () {
        ...
        it('esc should select nothing', function () {
          fireKey(Keycodes.ESC);
          assertDatesEqual(dp.getDate(), null, 'date');
        });

        it('enter then esc should select today', function () {
          fireKey(Keycodes.ENTER);
          fireKey(Keycodes.ESC);
          assertDatesEqual(dp.getDate(), moment$1(), 'date');
        });
